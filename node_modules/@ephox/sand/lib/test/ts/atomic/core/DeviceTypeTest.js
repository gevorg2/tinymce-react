...
UnitTest.test('DeviceTypeTest', function () {
    var getPlatform = function (userAgent) {
        return PlatformDetection.detect(userAgent, function () { return false; });
    };
    ...
    var iphone_ios13_safari = 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.1 Mobile/15E148 Safari/604.1';
    ...
    var ipad_ipados13_safari = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.1 Safari/605.1.15';
