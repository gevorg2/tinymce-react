...
export var exactly = function (required) { return base(handleExact, required); };
export var ensure = function (required) { return base(allowExtra, required); };
export var ensureWith = function (required, condition) { return baseWith(allowExtra, required, condition); };
