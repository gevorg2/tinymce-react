...
UnitTest.test('Resolve.resolve', function () {
...
UnitTest.test('Checking that creating a namespace (forge) from an obj will enable that value to be retrieved by resolving (path)', function () {
    ...
    fc.dictionary(fc.asciiString(), fc.dictionary(fc.asciiString(), fc.constant({})))), fc.array(fc.asciiString(1, 30), 1, 40), fc.asciiString(1, 30), fc.asciiString(1, 30), function (dict, parts, field, newValue) {
