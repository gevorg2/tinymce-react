...
UnitTest.test('Check that values should be empty and  errors should be all if we only generate errors', function () {
    fc.assert(fc.property(fc.array(arbResultError(fc.integer())), function (resErrors) {
...
UnitTest.test('Check that errors should be empty and values should be all if we only generate values', function () {
    fc.assert(fc.property(fc.array(arbResultValue(fc.integer())), function (resValues) {
...
UnitTest.test('Check that the total number of values and errors matches the input size', function () {
    fc.assert(fc.property(fc.array(arbResult(fc.integer(), fc.string())), function (results) {
...
UnitTest.test('Check that two errors always equal comparison.bothErrors', function () {
    fc.assert(fc.property(arbResultError(fc.integer()), arbResultError(fc.integer()), function (r1, r2) {
...
UnitTest.test('Check that error, value always equal comparison.firstError', function () {
    fc.assert(fc.property(arbResultError(fc.integer()), arbResultValue(fc.string()), function (r1, r2) {
        var comparison = Results.compare(r1, r2);
        return comparison.match({
...
UnitTest.test('Check that value, error always equal comparison.secondError', function () {
    fc.assert(fc.property(arbResultValue(fc.integer()), arbResultError(fc.string()), function (r1, r2) {
        var comparison = Results.compare(r1, r2);
        return comparison.match({
            bothErrors: Fun.constant(false),
            firstError: Fun.constant(false),
...
UnitTest.test('Check that value, value always equal comparison.bothValues', function () {
    fc.assert(fc.property(arbResultValue(fc.integer()), arbResultValue(fc.integer()), function (r1, r2) {
        var comparison = Results.compare(r1, r2);
        return comparison.match({
            bothErrors: Fun.constant(false),
            firstError: Fun.constant(false),
