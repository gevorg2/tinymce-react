...
export declare type RequestBody = JsonData | BlobData | TextData | FormData | MultipartFormData;
export declare type ResponseBody = Exclude<RequestBody, FormData>;
export declare type ResponseBodyDataTypes = Exclude<DataType, DataType.FormData>;
