...
Http.get({
    ...
    result.fold(function () { return console.log('error'); }, function (json) {
...
Http.del({
    ...
    result.fold(function () { return console.log('error'); }, function (text) {
...
Http.get({
    ...
    result.fold(function () { return console.log('error'); }, function (blob) {
...
Http.download({
    ...
    result.fold(function (e) { return console.log('download blob error', e); }, function (blob) {
        console.log('download blob', blob);
    });
});
var jwtFactory = function (flesh) { return FutureResult.pure('123'); };
HttpJwt.put({
    url: 'https://httpbin.org/put',
    body: HttpData.jsonData({ important: 'data' }),
    responseType: DataType.JSON
}, jwtFactory).get(function (result) {
    result.fold(function () { return console.log('error'); }, function (json) {
