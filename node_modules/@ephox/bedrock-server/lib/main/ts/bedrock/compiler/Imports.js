...
const generatePolyfills = (useRequire) => {
...
const generateImportsTs = (useRequire, scratchFile, srcFiles) => {
...
const generateImportsJs = (useRequire, scratchFile, srcFiles) => {
    const imports = srcFiles.map(filePathToImport(useRequire, scratchFile)).join('\n');
...
exports.generateImports = (useRequire, scratchFile, srcFiles) => {
