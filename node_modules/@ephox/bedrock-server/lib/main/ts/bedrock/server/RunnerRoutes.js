...
exports.generate = (mode, projectdir, basedir, configFile, bundler, testfiles, chunk, retries, singleTimeout, stopOnFailure, basePage, coverage) => {
    const files = testfiles.map((filePath) => {
        return path.relative(projectdir, filePath);
    });
    const testGenerator = Compiler.compile(path.join(projectdir, configFile), path.join(projectdir, 'scratch'), basedir, mode === 'auto', files, coverage);
    ...
    return precompiledTests.then((precompTests) => {
