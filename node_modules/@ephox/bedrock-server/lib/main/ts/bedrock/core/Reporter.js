...
exports.write = (settings) => {
    return (data) => {
        return new Promise((resolve) => {
            ...
            results.forEach((res) => {
                ...
                if (res.passed !== true) {
                    if (res.skipped) {
                        ...
                        const cdatas = exports.splitCdatas(res.error);
            ...
            if (failed.length > 0)
                resolve(Attempt_1.Attempt.failed(['Some tests failed. See {' + reportFile + '} for details.']));
            else
                resolve(Attempt_1.Attempt.passed(results));
        });
    };
};
exports.writePollExit = (settings, results) => {
