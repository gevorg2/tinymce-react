...
export var TinyApis = function (editor) {
    ...
    var cNodeChanged = function () { return Chain.op(function () {
        editor.nodeChanged();
    }); };
    ...
    var cGetContent = function () { return Chain.injectThunked(function () {
    ...
    var sAssertContentPresence = function (expected) {
        return Assertions.sAssertPresence(function () { return 'Asserting the presence of selectors inside tiny content. Complete list: ' + JSON.stringify(expected) + '\n'; }, expected, lazyBody());
    };
    ...
    var sFocus = function () { return Step.sync(function () {
        editor.focus();
    }); };
    var sNodeChanged = function () { return Step.sync(function () {
        editor.nodeChanged();
    }); };
    var sTryAssertFocus = function () { return Waiter.sTryUntil('Waiting for focus on tinymce editor', FocusTools.sIsOnSelector('iframe focus', Element.fromDom(document), 'iframe'), 100, 1000); };
    return {
