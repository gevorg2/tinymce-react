...
UnitTest.asynctest('NamedChainTest', function (success, failure) {
    ...
    var addLetters = function (s) {
        return Chain.mapper(function (input) { return input + s; });
    };
    var mult10 = Chain.mapper(function (input) { return input * 10; });
    var doubleNum = Chain.mapper(function (input) { return input * 2; });
            ...
            Chain.asStep('.', [
                NamedChain.asChain([
                    ...
                    NamedChain.bundle(function (input) {
                        Assert.eq('Checking bundled chain output', __assign(__assign({ 'x': 5 * 2, 'y': 8, '10y': 80, 'z': 10, 'description': 'Q1. What are the answers', 'shouting': 'Q1. What are the answers!', 'xyz': {
                                x: 10,
                                y: 8,
                                z: 10
                            } }, wrapObj(NamedChain.inputName(), '.')), wrapObj(_outputName(), _outputUnset())), input);
