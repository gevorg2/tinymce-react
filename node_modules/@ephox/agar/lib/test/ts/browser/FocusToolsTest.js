...
UnitTest.asynctest('FocusToolsTest', function (success, failure) {
    ...
    Pipeline.async({}, [
        ...
        Chain.asStep(doc, [
            ...
            Chain.control(Chain.on(function (active, next, die, logs) {
        ...
        Step.control(FocusTools.sIsOn('tryUntilNotCheck (sIsOn)', Element.fromTag('span')), Guard.tryUntilNot('Focus should not be on something that is not in the DOM')),
