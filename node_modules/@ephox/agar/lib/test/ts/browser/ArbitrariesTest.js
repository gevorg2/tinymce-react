...
UnitTest.test('Arbitraries Test', function () {
    ...
    checkProperty('Spans should have attributes and styles', Arbitraries.content('test-data', {
        ...
        return assertProperty('style and attr api', data, function (elem) { return Node.name(elem) === 'span' && (Attr.get(elem, 'data-a') !== 'b' || Css.getRaw(elem, 'color').getOr('') !== 'red'); });
    });
    ...
    checkProperty('Container elements', Arbitraries.content('container'), function (element) { return assertProperty('if display === inline, no descendants have display block', element, function (elem) {
        if (Css.get(elem, 'display') === 'inline') {
            var descendants = PredicateFilter.descendants(elem, function (kin) { return Node.isElement(kin) && Css.get(kin, 'display') !== 'inline'; });
    ...
    checkProperty('Formatting elements should only contain (display === inline)', Arbitraries.content('formatting'), function (section) { return assertProperty('nothing should have display block inside a formatting element', section, function (elem) { return !Compare.eq(section, elem) && Node.isElement(elem) && Css.get(elem, 'display') !== 'inline'; }); });
