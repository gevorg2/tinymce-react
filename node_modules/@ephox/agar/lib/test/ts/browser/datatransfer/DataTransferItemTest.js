...
UnitTest.asynctest('DataTransferItemTest', function (success, failure) {
    Pipeline.async({}, [
        Logger.t('Create transfer item from file', Step.sync(function () {
            var fileItem = createDataTransferItemFromFile(createDataTransfer(), createFile('a.txt', 1234, new Blob(['123'], { type: 'text/plain' })));
        ...
        Logger.t('Create transfer item from string', Step.async(function (next, die) {
            var stringItem = createDataTransferItemFromString(createDataTransfer(), 'text/plain', '123');
            ...
            stringItem.getAsString(function (text) {
                try {
