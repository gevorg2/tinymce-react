...
UnitTest.test('DataTransferItemListTest', function () {
    var testAdding = function () {
        var items = createDataTransferItemList(createDataTransfer());
    ...
    var testMutationWhileInProtectedMode = function () {
        var dataTransfer = createDataTransfer();
        var items = createDataTransferItemList(dataTransfer);
    ...
    var testMutationWhileInReadOnlyMode = function () {
        var dataTransfer = createDataTransfer();
        var items = createDataTransferItemList(dataTransfer);
