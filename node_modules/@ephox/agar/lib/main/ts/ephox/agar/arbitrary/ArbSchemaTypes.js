...
var toTags = function (detail) {
    return Obj.mapToArray(detail.tags, function (v, k) { return Merger.deepMerge(v, { tag: k }); });
};
...
export var create = function (construct) {
    ...
    var composite = function (detail) { return function (rawDepth) {
        var childGenerator = ArbChildrenSchema.composite(rawDepth, detail, construct);
        return combine(detail, childGenerator);
    }; };
    var leaf = function (detail) { return function (_) { return combine(detail, ArbChildrenSchema.none); }; };
    var structure = function (detail) { return function (rawDepth) {
        var childGenerator = ArbChildrenSchema.structure(rawDepth, detail, construct);
        return combine(detail, childGenerator);
    }; };
    var arbitrary = function (arb) { return function (_) { return arb.component; }; };
    return {
        arbitrary: arbitrary,
        leaf: leaf,
        structure: structure,
