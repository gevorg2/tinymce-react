...
var Editor = /** @class */ (function (_super) {
    ...
    function Editor(props) {
        ...
        _this.initialise = function () {
            var finalInit = __assign(__assign({}, _this.props.init), { target: _this.elementRef, readonly: _this.props.disabled, inline: _this.inline, plugins: mergePlugins(_this.props.init && _this.props.init.plugins, _this.props.plugins), toolbar: _this.props.toolbar || (_this.props.init && _this.props.init.toolbar), setup: function (editor) {
                    _this.editor = editor;
            ...
            if (isTextarea(_this.elementRef)) {
                _this.elementRef.style.visibility = '';
            }
    ...
    Editor.prototype.componentDidMount = function () {
        if (getTinymce() !== null) {
            ...
            ScriptLoader.load(this.elementRef.ownerDocument, this.getScriptSrc(), this.initialise);
        }
    };
    ...
    Editor.prototype.renderInline = function () {
        ...
        return React.createElement(tagName, {
            ref: function (r) { return _this.elementRef = r; },
            id: this.id
        });
    };
