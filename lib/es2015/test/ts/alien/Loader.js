...
var cRender = function (props) {
    return Chain.async(function (_, next, die) {
        ...
        ReactDOM.render(React.createElement("div", null,
            React.createElement(Editor, __assign({ ref: function (r) { return ref = r; } }, props, { init: init }))), getRoot());
    });
};
...
var cReRender = function (props) {
    return Chain.op(function (context) {
        ReactDOM.render(React.createElement("div", null,
            React.createElement(Editor, __assign({ ref: function (r) { return context.ref = r; } }, props))), getRoot());
    });
};
